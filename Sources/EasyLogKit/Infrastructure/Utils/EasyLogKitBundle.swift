...
public enum EasyLogKitBundle {
    ...
    public static var resourceProfile: USGSResourceProfile {
        if let raw = ProcessInfo.processInfo.environment["EASYLOG_RESOURCE_PROFILE"]?
        ...
        // Default to release assets unless explicitly overridden by EASYLOG_RESOURCE_PROFILE.
