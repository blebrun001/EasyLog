            ...
            for unit in sourceLog.units {
                ...
                remappedUnits.append(
                    RenderedUnit(
                        ...
                        symbol: sourceUnit?.symbol ?? SymbologyLibrary.style(forLithology: unit.lithology).symbol,
                        usgsSymbolCode: sourceUnit?.usgsSymbolCode ?? SymbologyLibrary.usgsSymbolCode(forLithology: unit.lithology),
                        fillHex: sourceUnit?.fillHex ?? SymbologyLibrary.style(forLithology: unit.lithology).fillHex,
