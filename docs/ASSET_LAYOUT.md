...
## Current Policy
- Runtime assets consumed by the app live under `Sources/CakeKit/Resources/USGSRuntime`.
- Heavy USGS source assets stay under `Sources/CakeKit/Resources/USGS` and are built by scripts.
